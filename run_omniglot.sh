...
#SBATCH --output=logs/omniglot_%j.out
#SBATCH --error=logs/omniglot_%j.err
#! Do not change:
#SBATCH -p ampere

#! set configurations to your REAL yaml file
options="configs/omniglot_config.yaml"
...
application="PYTHONPATH=. python -u src/training/train_fewshot.py"
